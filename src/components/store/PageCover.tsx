  ...
  return (
    <section className="relative isolate overflow-hidden px-5 pb-16 pt-28 text-cream sm:pt-32 lg:px-8">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <Reveal delay={0.05}>
          <h1 className="mt-3 font-display text-4xl font-bold tracking-tight drop-shadow-sm sm:text-6xl">
            {title}
          </h1>
        </Reveal>
        {description && (
      ...
      <svg
        ...
        className="absolute inset-x-0 bottom-0 z-10 h-10 w-full text-cream sm:h-16"
        fill="currentColor"
      >
